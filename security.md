...
- GitHub → the [wickra-synth repository](https://github.com/wickra-lib/wickra-synth)
...
Wickra Synth parses untrusted `ScanSpec` JSON and candle data, so its parser and
...
[SECURITY.md](https://github.com/wickra-lib/wickra-synth/blob/main/SECURITY.md)
